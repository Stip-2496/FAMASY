...
new #[Layout('layouts.auth')] class extends Component {
    ...
    public function mount(Proveedor $proveedor): void
    {
        ...
        $this->fill(
            $proveedor->only([
                'nomProve', 'apeProve', 'nitProve', 'conProve', 'telProve',
                'emailProve', 'dirProve', 'ciuProve', 'depProve', 'tipSumProve', 'obsProve'
            ])
        );
    }
    ...
    <div class="w-full max-w-7xl mx-auto bg-white/80 backdrop-blur-xl shadow rounded-3xl p-3 relative border border-white/20">
        ...
        <div class="text-center mb-3"
            ...
            <template x-if="!showSuccess && !showCancel">
                <p class="text-gray-600 text-xs">Actualiza la información del proveedor
            </template>
        </div>
        ...
        <form wire:submit="update" class="space-y-2">
                ...
                <div class="flex-1 border border-gray-300 rounded-3xl overflow-hidden">
                    ...
                    <div class="p-2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-2">
                            ...
                            <div>
                                <label for="nomProve" class="block text-[10px] font-bold text-gray-700 mb-0.5">
                            ...
                            <div>
                                <label for="apeProve" class="block text-[10px] font-bold text-gray-700 mb-0.5">
            ...
            <div class="flex justify-center space-x-2 pt-2">
                ...
                <button type="submit"
                    ...
                    <span class="relative z-10 text-xs">Actualizar Proveedor</span>
                </button>
            </div>
        </form>
    </div>
