                ...
                <div class="flex-1 border border-gray-300 rounded-lg p-4">
                    ...
                    <div class="flex gap-4 mb-4">
                        ...
                        <div class="flex-1">
                            ...
                            <input type="text" wire:model="numDocUsu" class="border p-2 rounded w-full text-black">
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 mb-4">
                        <div class="flex-1">
                            ...
                            <input type="text" wire:model="nomUsu" class="border p-2 rounded w-full text-black">
                        </div>
                        <div class="flex-1">
                            <label class="block text-sm font-medium text-gray-800 mb-1">Apellido</label>
                            <input type="text" wire:model="apeUsu" class="border p-2 rounded w-full text-black">
                        </div>
                    </div>
                ...
                <div class="flex-1 border border-gray-300 rounded-lg p-4">
                    ...
                    <div class="flex gap-4">
                        <div class="flex-1">
                            ...
                            <input type="text" wire:model="celCon" class="border p-2 rounded w-full text-black">
                        </div>
                        <div class="flex-1">
                            <label class="block text-sm font-medium text-gray-800 mb-1">Correo electrónico</label>
                            <input type="email" wire:model="email" class="border p-2 rounded w-full text-black">
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="border border-gray-300 rounded-lg p-4 mb-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-4">
                    <div>
                        ...
                        <input type="text" wire:model="calDir" class="border p-2 rounded w-full text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-1">Barrio</label>
                        <input type="text" wire:model="barDir" class="border p-2 rounded w-full text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-1">Ciudad</label>
                        <input type="text" wire:model="ciuDir" class="border p-2 rounded w-full text-black">
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                    <div>
                        ...
                        <input type="text" wire:model="depDir" class="border p-2 rounded w-full text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-1">Código postal</label>
                        <input type="text" wire:model="codPosDir" class="border p-2 rounded w-full text-black">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-800 mb-1">País</label>
                        <input type="text" wire:model="paiDir" class="border p-2 rounded w-full text-black">
                    </div>
                </div>
            </div>
