...
new #[Layout('layouts.auth')] class extends Component {
    ...
    public function save(): void
    {
        ...
        try {
            // Crear el mantenimiento con los datos validados
            ...
            session()->flash('success', 'Mantenimiento programado exitosamente');
            $this->redirect(route('inventario.mantenimientos.index'), navigate: true);
        } catch (\Exception $e) {
            session()->flash('error', 'Error al programar el mantenimiento: ' . $e->getMessage());
        }
    }
                        ...
                        <div class="p-6">
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div class="md:col-span-2">
                                    ...
                                    <input type="text" wire:model="nomHerMan" id="nomHerMan" required maxlength="255"
                ...
                <div class="lg:col-span-1 space-y-6">
                    ...
                    <div class="bg-white shadow rounded-lg">
                        ...
                        <div class="p-6">
                            <div class="space-y-4 text-sm">
                                <div>
                                    <h4 class="font-medium text-gray-900 mb-2">Tipos de Mantenimiento:</h4>
                                    <ul class="space-y-1 text-gray-600">
                                        <li><strong>Preventivo:</strong> Programado regularmente</li>
                                        <li><strong>Correctivo:</strong> Para reparar fallas</li>
                                        <li><strong>Predictivo:</strong> Basado en condiciones</li>
                                    </ul>
                                </div>
                                
                                <div>
                                    <h4 class="font-medium text-gray-900 mb-2">Estados:</h4>
                                    <ul class="space-y-1 text-gray-600">
                                        <li><strong>Pendiente:</strong> Programado pero no iniciado</li>
                                        <li><strong>En Proceso:</strong> Actualmente ejecutándose</li>
                                        <li><strong>Completado:</strong> Finalizado</li>
                                    </ul>
                                </div>
                                
                                <div class="bg-blue-50 border border-blue-200 rounded-lg p-3">
                                    <p class="text-blue-800 text-xs">
                                        <strong>Tip:</strong> Para mantenimientos completados, asegúrate de llenar el campo "Resultado" con los detalles del trabajo realizado.
                                    </p>
                                </div>
                            </div>
                        </div>
